...
>Наличие нешифрованных DNS, принципиально должно быть.  
В купе с исключением провайдерского DNS, отсутствие альтернативных нешифрованных DNS приведёт к проблемам с bootstrap DNS for DoT|DoH после перезагрузки роутера, и/или к отсутствию интернета на роутере и на подключенных устройствах после перезагрузки, и особенно при сбоях|блокировках AWG протокола.
>
