...
#### Обратите внимание, что ***все*** файлы должы быть с обозначением конца строки в файле в Unix (LF):  
...
Нам требуется добавить в conf-файл пареметры пакетов имитации *i1...i5*.  
...
Подключитесь через загруженый в приложение conf-файл.  
...
### Если что-то пошло не так, например, ничего не открывается - пробуйте использовать другие пареметры пакетов имитации *i1...i5* в conf-файле.
...
Для работы нам понадобится как минимум следующий рабор компоентов KeenOS:  
![KeenOS сomponents 1](!img/06__System-Componenets_1.png)  

![KeenOS сomponents 2](!img/06__System-Componenets_2.png)  
